<cffunction name="queryStringToStruct" access="public" returntype="struct" output="false" hint="I accept a url query string and return it as a structure.">
	...
	<cfargument name="delimiter" type="string" required="false" default="&" hint="I am the delimiter of the query string.">
	...
	<cfloop list="#arguments.queryString#" index="local.queryStringindex" delimiters="#arguments.delimiter#">
